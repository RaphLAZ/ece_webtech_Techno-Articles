...
export default function HomePage({articles}) {
    ...
    const carouselImages = [{src: "/cybersecurity.jpg", alt: "Picture 1"}, {
        src: "/software.jpg",
        alt: "Picture 2"
    }, {src: "/technologies.jpg", alt: "Picture 3"},];

    const welcomeMessage = user ? `Welcome back ${user.username} to Techno Articles!` : "Welcome to Techno Articles!";
    ...
    return (<Layout>
        <div className="max-w-3xl mx-auto py-8 px-4">
            ...
            <br/>
            {displayedArticles.map((article) => (<div
                key={article.id}
